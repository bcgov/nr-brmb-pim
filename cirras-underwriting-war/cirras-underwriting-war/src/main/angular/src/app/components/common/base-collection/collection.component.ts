...
export class CollectionComponent extends BaseComponent implements OnChanges, AfterViewInit {
    ...
    constructor(protected router: Router,
        ...
        super(router, route, sanitizer, store, fb, dialog, applicationStateService, securityUtilService, tokenService, connectionService, snackbarService, overlay, cdr, appConfigService, http, titleService);
    }

    baseRoute = undefined;
    searchText = undefined; //not use, but leave this.
    searchGrower = undefined;
    searchPolicyNumber = undefined;
    searchLandIdentifier = undefined;
    searchLegalLocation = undefined;
    selectedDataset = undefined;
    selectedCropYear = undefined;
    selectedInsurancePlan = undefined;
    selectedPolicyStatus = undefined;
    selectedOffice = undefined;
    selectedReportType = undefined;
    selectedReportSortBy = undefined;
    collectionData: any[];
    reportCollectionData: any[];
    ...
    selectFilterUpdatedNoSearch(property, value) {
        this[property] = value;
        this.cdr.detectChanges();
        // this.onChangeFilters();
      }
