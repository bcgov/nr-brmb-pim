...
import { ADD_UW_YEAR, ADD_UW_YEAR_ERROR, LOAD_VARIETY_INSURABILITY, LOAD_VARIETY_INSURABILITY_ERROR, LOAD_VARIETY_INSURABILITY_SUCCESS, 
  ...
  SAVE_SEDING_DEADLINES, SAVE_SEDING_DEADLINES_SUCCESS, SAVE_VARIETY_INSURABILITY, SAVE_VARIETY_INSURABILITY_SUCCESS, LOAD_YIELD_CONVERSION_SUCCESS, SAVE_YIELD_CONVERSION, SAVE_YIELD_CONVERSION_SUCCESS, 
  LOAD_USER_SETTINGS,
  LOAD_USER_SETTINGS_SUCCESS,
  LOAD_USER_SETTINGS_ERROR} from "../maintenance/maintenance.actions";
import { MAINTENANCE_COMPONENT_ID, USER_SETTINGS_COMPONENT_ID } from "../maintenance/maintenance.state";
...
export function getStatePropertyNameForActionName(action: Action): string {
  ...
  switch (actionType) {
    ...
    case LOAD_USER_SETTINGS_SUCCESS:
    case LOAD_USER_SETTINGS_ERROR:
      return USER_SETTINGS_COMPONENT_ID;
