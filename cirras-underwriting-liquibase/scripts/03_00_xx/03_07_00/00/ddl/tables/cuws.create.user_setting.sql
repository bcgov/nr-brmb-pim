...
;
COMMENT ON COLUMN cuws.user_setting.crop_year IS 'Crop Year is the user''s preferred crop year to search for on the policy screen'
;
COMMENT ON COLUMN cuws.user_setting.insurance_plan_id IS 'Insurance Plan Id is the user''s  preferred insurance plan to search for on the policy screen.'
;
COMMENT ON COLUMN cuws.user_setting.office_id IS 'Office Id is the user''s prefered office to search for on the policy screen.'
;
