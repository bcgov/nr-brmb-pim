CREATE TABLE cuws.user_setting(
    user_setting_guid                  varchar(32)      NOT NULL,
...
COMMENT ON COLUMN cuws.user_setting.user_setting_guid IS 'User Setting Guid is a unique key of an underwriting user '
;
...
ALTER TABLE cuws.user_setting ADD 
    CONSTRAINT pk_us PRIMARY KEY (user_setting_guid) USING INDEX TABLESPACE pg_default 
;
