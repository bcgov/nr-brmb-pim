...
import ca.bc.gov.mal.cirras.underwriting.data.repositories.mapper.UserSettingMapper;
...
public class UserSettingDao extends BaseDao {
	...
	private static final Logger logger = LoggerFactory.getLogger(UserSettingDao.class);
