...
import ca.bc.gov.mal.cirras.underwriting.data.repositories.mapper.SyncOwnershipMapper;
...
@Repository
public class SyncOwnershipDao extends BaseDao {

	private static final long serialVersionUID = 1L;

	private static final Logger logger = LoggerFactory.getLogger(SyncOwnershipDao.class);
