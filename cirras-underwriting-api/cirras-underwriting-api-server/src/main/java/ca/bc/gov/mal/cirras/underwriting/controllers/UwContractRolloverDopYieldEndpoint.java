...
@Path("/uwcontracts/{policyId}/rolloverDopYieldContract")
public class UwContractRolloverDopYieldEndpoint extends BaseEndpointsImpl {

	@Autowired
	private CirrasDopYieldService cirrasDopYieldService;
	
	@Operation(operationId = "Rollover the dop yield contract.", summary = "Returns a new dop yield contract based on the inventory of the policy", security = @SecurityRequirement(name = "Webade-OAUTH2", scopes = {Scopes.CREATE_DOP_YIELD_CONTRACT}), extensions = {@Extension(properties = {@ExtensionProperty(name = "auth-type", value = "#{wso2.x-auth-type.none}"), @ExtensionProperty(name = "throttling-tier", value = "Unlimited") })})
	@Parameters({
	...
	public Response rolloverDopYieldContract(
