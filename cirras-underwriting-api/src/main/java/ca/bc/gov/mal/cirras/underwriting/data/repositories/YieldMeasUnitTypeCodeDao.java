...
import ca.bc.gov.mal.cirras.underwriting.data.repositories.mapper.YieldMeasUnitTypeCodeMapper;
...
@Repository
public class YieldMeasUnitTypeCodeDao extends BaseDao {

	private static final long serialVersionUID = 1L;

	private static final Logger logger = LoggerFactory.getLogger(YieldMeasUnitTypeCodeDao.class);
