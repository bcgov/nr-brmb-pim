...
import ca.bc.gov.mal.cirras.underwriting.data.repositories.mapper.CropCommodityMapper;
...
public class CropCommodityDao extends BaseDao {
	...
	private static final Logger logger = LoggerFactory.getLogger(CropCommodityDao.class);
