...
import ca.bc.gov.mal.cirras.underwriting.data.repositories.mapper.GradeModifierMapper;
...
@Repository
public class GradeModifierDao extends BaseDao {

	private static final long serialVersionUID = 1L;

	private static final Logger logger = LoggerFactory.getLogger(GradeModifierDao.class);
