...
public interface DeclaredYieldFieldCommodityBerriesMapper {

	DeclaredYieldFieldCommodityBerriesDto fetch(Map<String, Object> parameters);
    ...
    List<DeclaredYieldFieldCommodityBerriesDto> selectToRecalculate(Map<String, Object> parameters);
