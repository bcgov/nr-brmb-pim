...
import ca.bc.gov.mal.cirras.underwriting.data.repositories.mapper.GrowerContactMapper;
...
@Repository
public class GrowerContactDao extends BaseDao {

	private static final long serialVersionUID = 1L;

	private static final Logger logger = LoggerFactory.getLogger(GrowerContactDao.class);
