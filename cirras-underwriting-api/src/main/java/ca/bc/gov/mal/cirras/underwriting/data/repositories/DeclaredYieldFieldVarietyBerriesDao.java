...
import ca.bc.gov.mal.cirras.underwriting.data.repositories.mapper.DeclaredYieldFieldVarietyBerriesMapper;
...
@Repository
public class DeclaredYieldFieldVarietyBerriesDao extends BaseDao {

	private static final long serialVersionUID = 1L;

	private static final Logger logger = LoggerFactory.getLogger(DeclaredYieldFieldVarietyBerriesDao.class);

	@Autowired
	private DeclaredYieldFieldVarietyBerriesMapper mapper;

	
	public DeclaredYieldFieldVarietyBerriesDto fetch(String declaredYieldFieldVarietyBerriesGuid) throws DaoException {
		logger.debug("<fetch");

		DeclaredYieldFieldVarietyBerriesDto result = null;

		try {
			Map<String, Object> parameters = new HashMap<String, Object>();
			parameters.put("declaredYieldFieldVarietyBerriesGuid", declaredYieldFieldVarietyBerriesGuid);
	...
	public void insert(DeclaredYieldFieldVarietyBerriesDto dto, String userId) throws DaoException {
		logger.debug("<insert");
		...
		try {
			...
			declaredYieldFieldVarietyBerriesGuid = (String) parameters.get("declaredYieldFieldVarietyBerriesGuid");
			dto.setDeclaredYieldFieldVarietyBerriesGuid(declaredYieldFieldVarietyBerriesGuid);
		...
		logger.debug(">insert " + declaredYieldFieldVarietyBerriesGuid);
	}
	

	
	public void update(DeclaredYieldFieldVarietyBerriesDto dto, String userId) 
	...
	public void delete(String declaredYieldFieldVarietyBerriesGuid) throws DaoException, NotFoundDaoException {
		logger.debug("<delete");
	...
	public List<DeclaredYieldFieldVarietyBerriesDto> select(String declaredYieldFieldCommodityBerriesGuid) throws DaoException {
		List<DeclaredYieldFieldVarietyBerriesDto> dtos = null;
...
/*
	...
	public  List<DeclaredYieldFieldCommodityBerriesDto> selectToRecalculate(
