...
@RestController
@Path("/growercontact")
public class GrowerContactEndpoint extends BaseEndpointsImpl {
	
	private static final Logger logger = LoggerFactory.getLogger(GrowerContactEndpoint.class);
	...
	public Response synchronizeGrowerContact(
		...
		logRequest();
		logResource(growerContact, "synchronizeGrowerContact");
	...
	public Response getGrowerContact(
