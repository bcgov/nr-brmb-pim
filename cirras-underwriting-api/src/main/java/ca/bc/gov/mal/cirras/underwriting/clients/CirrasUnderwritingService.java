...
public class CirrasUnderwritingService extends BaseRestServiceClient {
	...
	private static final Logger logger = LoggerFactory.getLogger(CirrasUnderwritingService.class);
	 ...
	 */
	public CirrasUnderwritingService(String webadeOauth2ClientId, String webadeOauth2ClientSecret, String webadeOauth2TokenUrl, String scopes) {
	 ...
	 * @param webadeOauth2ClientSecret
	 */
	public CirrasUnderwritingService(String webadeOauth2ClientId, String webadeOauth2ClientSecret) {
	 ...
	 * @param headerValue
	 */
	public CirrasUnderwritingService(String headerValue) {
		super(headerValue);
		logger.debug("<CirrasUnderwritingServiceImpl");
	 ...
	 * 
	 */
	public CirrasUnderwritingService() {
		super();
		logger.debug("<CirrasUnderwritingServiceImpl");
	...
	public ReplaceLegalValidationRsrc validateReplaceLegal(UwContractRsrc resource, String annualFieldDetailId, String fieldLabel, String legalLandId, String fieldLocation) throws CirrasUnderwritingServiceException {
