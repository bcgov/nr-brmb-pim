...
@Repository
public class AnnualFieldDetailDaoImpl extends BaseDao implements AnnualFieldDetailDao {

	private static final long serialVersionUID = 1L;

	private static final Logger logger = LoggerFactory.getLogger(AnnualFieldDetailDaoImpl.class);
