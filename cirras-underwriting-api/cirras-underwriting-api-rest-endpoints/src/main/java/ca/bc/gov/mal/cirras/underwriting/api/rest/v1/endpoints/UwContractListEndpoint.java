...
public interface UwContractListEndpoint extends BaseEndpoints {
	...
	@ApiResponses(value = {
		@ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = UwContractListRsrc.class)), headers = @Header(name = HeaderConstants.ETAG_HEADER, schema = @Schema(implementation = String.class), description = HeaderConstants.ETAG_DESCRIPTION)),
	...
	Response getUwContractList(
		...
		@Parameter(description = "Filter the results by the dataset type (LINKED_GF_POLICIES") @QueryParam("datasetType") String datasetType,
