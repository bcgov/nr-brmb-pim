...
public class UwContractValidateRenameLegalEndpointTest extends EndpointsTest {
	...
	@Test
	public void testValidateRenameLegal() throws CirrasUnderwritingServiceException, Oauth2ClientException, ValidationException {
		logger.debug("<testValidateRenameLegal");
		...
		Assert.assertEquals(RenameLegalValidation.LEGALS_WITH_SAME_LOC_MSG, renameLegalValidation.getLegalsWithSameLocMsg().getMessage());
		...
		Assert.assertEquals(RenameLegalValidation.OTHER_LEGAL_DATA_MSG, renameLegalValidation.getOtherLegalDataMsg().getMessage());
		...
		Assert.assertEquals(RenameLegalValidation.OTHER_FIELD_ON_POLICY_MSG, renameLegalValidation.getOtherFieldOnPolicyMsg().getMessage());
		...
		Assert.assertEquals(RenameLegalValidation.FIELD_ON_OTHER_POLICY_MSG, renameLegalValidation.getFieldOnOtherPolicyMsg().getMessage());
