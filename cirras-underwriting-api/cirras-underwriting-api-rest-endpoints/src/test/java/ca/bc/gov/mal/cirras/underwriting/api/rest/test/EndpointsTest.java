package ca.bc.gov.mal.cirras.underwriting.api.rest.test;
...
public abstract class EndpointsTest {
	...
	public static final String WebadeOauth2ClientId = "TEST_SERVICE_CLIENT";
	protected static final String WebadeOauth2ClientSecret = "password";

	protected static final String WebadeOauth2ClientGuid2 = "9374JD83HD94JSLE893H3N58DJE74222";
	public static final String WebadeOauth2ClientId2 = "TEST_SERVICE_CLIENT_2";
	protected static final String WebadeOauth2ClientSecret2 = "password";

	protected static final String clientAppCode = "CIRRAS_UNDERWRITING_REST";
	...
	public static void startServer() throws Exception {
		...
		{
			DataSource dataSource = testApplicationContext.getBean("cirrasUnderwritingDataSource", DataSource.class);
			dataSources.put("jdbc/cirras_underwriting_rest", dataSource);
		}
		{
	...
	protected CirrasUnderwritingService getService(String[] scopesArray) throws Oauth2ClientException {
		String scopes = "";
	...
	protected CirrasUnderwritingService getServiceSecondUser(String[] scopesArray) throws Oauth2ClientException {
		String scopes = "";
