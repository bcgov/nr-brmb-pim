...
import ca.bc.gov.mal.cirras.underwriting.listener.api.rest.v1.jersey.JerseyApplication;
...
public class ApplicationInitializer extends AbstractSecurityWebApplicationInitializer {
	...
	protected void beforeSpringSecurityFilterChain(ServletContext servletContext) {
        ...
        requestMetricsFilter.setInitParameter("id_source", "CIRRASUNDERWRITINGLISTENERAPI");
