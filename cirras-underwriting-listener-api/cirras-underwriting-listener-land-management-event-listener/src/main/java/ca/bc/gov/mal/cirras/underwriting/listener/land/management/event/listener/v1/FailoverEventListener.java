...
public class FailoverEventListener implements ApplicationListener<ApplicationEvent> {
	...
	public void onApplicationEvent(ApplicationEvent event) {
		logger.info("<onApplicationEvent (Underwriting Land Management)");
	...
	private void start() {
		logger.info("<start (Underwriting Land Management)");
	...
	private void stop() {
		logger.info("<stop (Underwriting Land Management)");
